...
export class SettingsComponent implements OnInit {
  ...
  addFriend() {
    if (this.webIdAddFriend.trim()!== '${this.nameWebIdFriend}.solid.community/profile/card#me') {
      this.toastr.error('Please add a right webId', 'Wrong input');
  ...
  removeFriend() {
    if (this.webIdRemoveFriend.trim()!== '${this.nameWebIdFriend}.solid.community/profile/card#me') {
      this.toastr.error('Please add a right webId', 'Wrong input');
